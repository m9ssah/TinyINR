      ...
      <article className="pb-20">
        ...
        <div className="mx-auto mt-12 max-w-3xl px-6">
          <div className="prose max-w-none">
            ...
            <p>
              TinyINR treats signals as coordinate-value relationships. Instead
              of storing only pixels or samples, the project asks what happens
              when a model learns a continuous function from coordinates to
              values, then learns how those values move under a generative flow.
            </p>

            <p>
              That framing makes Fourier embeddings, coordinate batches, and
              CUDA kernels part of the same story. The website is organized as a
              notebook for those pieces: what each component does, why the shape
              contract matters, and where GPU acceleration begins to pay off.
            </p>

            <h2>The mental model</h2>

            <p>
              For image-like data, each point can be written as a coordinate and
              a value. A 32 by 32 RGB image becomes 1,024 coordinate-value
              pairs, where each coordinate stores an x-y position and each value
              stores RGB.
            </p>
...
embedding:   [B, H * W, 2 * D * F]`}</code>
            ...
            <div className="relative my-10 overflow-hidden rounded-xl border border-border bg-surface p-6">
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-secondary">
                  ...
                  represented, sampled, embedded, and eventually transported.
                </p>
              </div>
            </div>
            ...
            <p>
              ...
              functions. Fourier coordinate embeddings give the network a richer
              basis by mapping every coordinate value through sine and cosine
              bands.
            </p>

            <MathDisclosure title="Coordinate embedding formula">
              <p>
                For a coordinate value x and frequency band f, the current Week
                4 kernel target is:
              </p>
              <pre>
...
cos(pi * frequency[f] * x)`}</code>
            ...
            <p>
              Flow matching learns a vector field that moves samples from one
              distribution to another. In TinyINR, the interesting question is
              how to do this over coordinate-value structures rather than fixed
              grids alone.
            </p>

            <ul>
              <li>
                <strong>Tensor</strong> gives every module shared CPU storage
                and shape rules.
              </li>
              <li>
              ...
              <li>
                <strong>FourierEmbedding</strong> makes coordinates easier for
                an MLP to model.
              </li>
              <li>
            ...
            <p>
              The right first GPU milestone is not a complete tensor runtime. It
              is one custom kernel that is correct, benchmarked, and easy to
              explain.
            </p>
